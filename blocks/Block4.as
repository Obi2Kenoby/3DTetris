package blocks
{
	...
	{
		public function Block4(XYGrid:IsoGrid, scene:IsoScene, stage:Stage, gameData:GameData, frozenBlockPartList:Array, moveable:Boolean)
		{
			...
			// part 3
			moveBlockPart(part3, part2.x - cellSize, part2.y - cellSize, part2.z);
			
			// part 4
			moveBlockPart(part4, part2.x - cellSize, part2.y, part2.z);
		}
	}
}