package blocks
{
	...
	{	
		...
		public function Block1(XYGrid:IsoGrid, scene:IsoScene, stage:Stage, gameData:GameData, frozenBlockPartList:Array, moveable:Boolean)
		{
			...
			// part 3
			moveBlockPart(part3, part2.x, part2.y + cellSize, part2.z);
			
			// part 4
			moveBlockPart(part4, part2.x, part2.y + cellSize*2, part2.z);
		}
